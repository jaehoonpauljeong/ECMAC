...
#ifndef ___CMAC1609_4_TWOWAY_H_
#define ___CMAC1609_4_TWOWAY_H_
 ...
 * @see CMac1609_4TwoWay
 * @see PhyLayer80211p
 * @see Decider80211p
 */
class CMac1609_4TwoWay : public BaseMacLayer,
	...
	public:
		...
		typedef std::map<std::string, std::vector<cModule*>> edgeIdVehMapType;
		edgeIdVehMapType vehMapEdgeId;
		typedef std::map<std::string, int> edgeIdChIdType;
		edgeIdChIdType edgeIdChannel;
		std::vector<cModule*> vehs_Vec;

		uint32_t m_activeVehCount;
		...
		cModule* findCenter(cModule*, CMac1609_4TwoWay*, float&, cModule* & );
...
bool cmpFunction_cmactwoway(cModule*, cModule* );
